    ...
    public function run(): void
    {
        ...
        $blogs = [
            ...
            [
                ...
                'description' => 'শীতার্ত মানুষের পাশে দাঁড়াতে ঝাউগড়া কল্যাণ সংগঠন ২০০টি কম্বল বিতরণ করেছে। এলাকার অসহায় ও দুস্থ মানুষের মাঝে এসব কম্বল পৌঁছে দেওয়া হয়।',
                'image' => 'image/Bosro.jpg',
                'event_date' => '২০২৬-০১-০৫',
            ],
            [
            ...
            [
                'title' => 'মাদক প্রতিরোধে সচেতনতা সভা',
                'description' => 'মাদকের ক্ষতিকর প্রভাব সম্পর্কে তরুণদের সচেতন করতে একটি সভার আয়োজন করে সংগঠন। এতে এলাকার গণ্যমান্য ব্যক্তি ও শিক্ষার্থীরা অংশ নেন।',
                'image' => 'image/madok.jpg',
                'event_date' => '২০২৫-১১-২৫',
            ],
            [
