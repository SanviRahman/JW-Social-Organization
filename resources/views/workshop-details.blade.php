...
<head>
    ...
    <title>{{ $workshop->title }} | ঝাউগড়া কল্যাণ সংগঠন</title>
    ...
    @endif
    <style>
    /* ===== Global Styles (consistent with event-details) ===== */
    * {
        margin: 0;
        padding: 0;
    ...
    .workshop-details .workshop-image {
        height: 450px;
        border-radius: 20px;
        overflow: hidden;
    ...
    .workshop-details .workshop-image img {
        width: 100%;
        height: 100%;
        object-fit: cover;
    ...
    .workshop-details .workshop-image:hover img {
    ...
    /* trainer card (similar to organizer card) */
    .trainer-card {
        background: #1f2937;
        border-radius: 20px;
        padding: 40px;
    ...
    /* related workshops grid (matching events grid) */
    .related-grid {
        display: grid;
        grid-template-columns: repeat(3, 1fr);
        gap: 30px;
...
<body>
    <main>
        ...
        <section class="page-header reveal">
            <div class="container">
                <h1 class="page-title">কর্মশালার বিস্তারিত</h1>
                <div class="breadcrumb reveal delay-1">
                    <a href="{{ url('/') }}#কার্যক্রম">হোম</a> / <span>{{ $workshop->title }}</span>
                </div>
            </div>
        </section>
        ...
        <section class="section-dark" style="padding-bottom: 50px;">
            <div class="container">
                <div class="workshop-details reveal-up">
                    ...
                    <div class="workshop-info">
                        ...
                        <div class="workshop-meta">
                            <span><i class="far fa-calendar-alt"></i>
                                {{ $workshop->created_at->format('d F Y') }}</span>
                            <span><i class="far fa-clock"></i> সকাল ১০:০০ - দুপুর ১:০০</span> <!-- static example -->
                            <span><i class="fas fa-user-tie"></i> জনাব আব্দুর রহিম</span>
                        </div>
                        <div class="workshop-description">
                            <p>{{ $workshop->description }}</p>
                        </div>
                        <a href="{{ url('/') }}#কার্যক্রম" class="back-btn"><i class="fas fa-arrow-left"></i> কার্যক্রম
                            পাতায় ফিরুন</a>
                    </div>
                </div>
            </div>
        ...
        <!-- 5. সম্পর্কিত কর্মশালা (Related Workshops) -->
        @if(isset($relatedWorkshops) && $relatedWorkshops->count() > 0)
        <section class="section-dark" style="padding-top: 0;">
            <div class="container">
                <div class="section-divider reveal"></div>
                <h2 class="section-title reveal">আরও কিছু কার্যক্রম</h2>
                <p class="section-subtitle reveal delay-1">আপনার জন্য অন্যান্য কর্মশালা</p>
                ...
                <div class="related-grid">
                    ...
                    <div class="related-card reveal-up">
                        ...
                        <div class="card-content">
                            ...
                            <a href="{{ route('workshop.details', $related->id) }}" class="card-link">
        ...
        <!-- 2. কর্মশালার সময়সূচী (Schedule) -->
        <section class="section-dark" style="padding-top: 0;">
            <div class="container">
                <div class="section-divider reveal"></div>
                <h2 class="section-title reveal">কর্মশালার সময়সূচী</h2>
                <p class="section-subtitle reveal delay-1">দিনভর যা যা ঘটবে</p>

                <div class="schedule-list reveal-up">
                    <div class="schedule-item">
                        <span class="schedule-time">১০:০০ - ১০:৩০</span>
                        <span class="schedule-activity">নিবন্ধন ও পরিচিতি</span>
                    </div>
                    <div class="schedule-item">
                        <span class="schedule-time">১০:৩০ - ১১:৩০</span>
                        <span class="schedule-activity">প্রথম সেশন: মৌলিক ধারণা</span>
                    </div>
                    <div class="schedule-item">
                        <span class="schedule-time">১১:৩০ - ১১:৪৫</span>
                        <span class="schedule-activity">চা বিরতি</span>
                    </div>
                    <div class="schedule-item">
                        <span class="schedule-time">১১:৪৫ - ১২:৪৫</span>
                        <span class="schedule-activity">দ্বিতীয় সেশন: ব্যবহারিক অনুশীলন</span>
                    </div>
                    <div class="schedule-item">
                        <span class="schedule-time">১২:৪৫ - ০১:০০</span>
                        <span class="schedule-activity">প্রশ্নোত্তর ও সমাপ্তি</span>
                    </div>
                </div>
            </div>
        </section>
        ...
        <!-- 4. অংশগ্রহণকারীদের মতামত (Testimonials) -->
        <section class="section-dark" style="padding-top: 0;">
            <div class="container">
                <div class="section-divider reveal"></div>
                <h2 class="section-title reveal">অংশগ্রহণকারীদের মতামত</h2>
                <p class="section-subtitle reveal delay-1">পূর্ববর্তী কর্মশালার কিছু অনুভূতি</p>

                <div class="testimonials-grid">
                    <div class="testimonial-card reveal-up">
                        <i class="fas fa-quote-right"></i>
                        <p>"অসাধারণ আয়োজন! প্রশিক্ষকের বক্তব্য ছিল প্রাণবন্ত ও ব্যবহারিক।"</p>
                        <p class="author">- ফারহানা আক্তার, স্বেচ্ছাসেবক</p>
                    </div>
                    <div class="testimonial-card reveal-up delay-1">
                        <i class="fas fa-quote-right"></i>
                        <p>"কর্মশালার প্রতিটি সেশন ছিল তথ্যবহুল এবং সময়ানুবর্তিতা চোখে পড়ার মতো।"</p>
                        <p class="author">- মোঃ সাইফুল ইসলাম, শিক্ষক</p>
                    </div>
                    <div class="testimonial-card reveal-up delay-2">
                        <i class="fas fa-quote-right"></i>
                        <p>"আমার প্রত্যাশার চেয়েও বেশি কিছু শিখতে পেরেছি। ধন্যবাদ আয়োজকদের।"</p>
                        <p class="author">- নাজমা বেগম, গৃহিণী</p>
                    </div>
                </div>
            </div>
        </section>
    ...
    <!-- Scroll reveal script (same as other pages) -->
    <script>
